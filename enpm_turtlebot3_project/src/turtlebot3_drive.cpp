...
#include "enpm_turtlebot3_project/turtlebot3_drive.hpp"
    ...
    case GET_TB3_DIRECTION:
      if (scan_data_[CENTER] > check_forward_dist) {
        if (scan_data_[LEFT] < check_side_dist) {
          ...
          RCLCPP_INFO(this->get_logger(), "Obstacle detected in the left.........");
        } else if (scan_data_[RIGHT] < check_side_dist) {
          prev_robot_pose_ = robot_pose_;
          turtlebot3_state_num = TB3_LEFT_TURN;
          RCLCPP_INFO(this->get_logger(), "Obstacle detected in the right.........");
        }else{
      ...
      if (scan_data_[CENTER] < check_forward_dist) {
        prev_robot_pose_ = robot_pose_;
        turtlebot3_state_num = TB3_RIGHT_TURN;
        RCLCPP_INFO(this->get_logger(), "Obstacle detected in the front.........");
      }
      break;
